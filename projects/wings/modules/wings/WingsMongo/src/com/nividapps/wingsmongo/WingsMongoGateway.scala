package com.nividapps.wingsmongo

import com.mongodb._

import com.iteration3.smile.mongo.MongoGateway

object WingsMongoGateway extends MongoGateway {

  val getDb: com.mongodb.client.MongoDatabase = {

    val conf:com.iteration3.smile.Conf = com.nividapps.wingsmongo.WingsMongoObject.conf
